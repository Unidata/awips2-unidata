package edu.ucar.unidata.uf.viz.streamflow.rsc.handler;
...
import edu.ucar.unidata.uf.viz.streamflow.rsc.StreamflowResourceData;
...
public class StreamflowResourceLoader extends AbstractHandler {
            ...
            if (editor != null) {
                ...
                if (editor instanceof IDisplayPaneContainer) {
                    ...
                    for (IDisplayPane pane : container.getDisplayPanes()) {
                        ...
                        StreamflowResourceData data = new StreamflowResourceData();
