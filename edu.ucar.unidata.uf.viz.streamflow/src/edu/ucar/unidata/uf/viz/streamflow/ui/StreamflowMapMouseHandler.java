...
public class StreamflowMapMouseHandler extends InputAdapter {

	private static final IUFStatusHandler statusHandler = UFStatus
            .getHandler(StreamflowMapMouseHandler.class);
	
	public StreamflowMapMouseHandler() {
		instance = this;
	}

	private static final double MinDistance = 20000;
	
	private static StreamflowMapMouseHandler instance;
    ...
    public static StreamflowMapMouseHandler getAccess() {
        return instance;
    }
    ...
    public boolean handleMouseMove(Event e) {
    	int x = e.x;
    	int y = e.y;
    	AbstractEditor mapEditor = StreamflowMapResource.getMapEditor();
    	...
    	if (mapEditor != null) {
            ...
            List<StreamflowStation> pts = StreamflowMapResource
        			.getOrCreateStreamflowMapResource().getPoints();
    ...
    public boolean handleMouseUp(int x, int y, int button) {
        ...
        if (!StreamflowMapResource.getMapRsc().isEditable())
            return false;
        ...
        if (button == 1) {
                ...
                if (pt != null) {
	                try {
	                    ...
	                    if (mgr != null) {
	                        ...
	                        new LoadBundleHandler("bundles/streamflow/timeseries.xml", 
            ...
            List<StreamflowStation> pts = StreamflowMapResource
        			.getOrCreateStreamflowMapResource().getPoints();
            StreamflowStation pt = getPtWithinMinDist(pts, loc);
            StreamflowMapResource.getOrCreateStreamflowMapResource().setPickedPoint(pt);
