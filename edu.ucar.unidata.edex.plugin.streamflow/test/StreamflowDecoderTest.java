...
import edu.ucar.unidata.edex.plugin.streamflow.StreamflowDecoder;

public class StreamflowDecoderTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            InputStream stream = StreamflowDecoderTest.class.getResourceAsStream("usgs.txt");
